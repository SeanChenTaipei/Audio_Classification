...
def train(X, y, X_public, X_private, models, output_path=None, weights=None):
    ...
    if output_path is not None:
        ...
        y = pd.concat((y_prob_public, y_prob_private))
        y.to_csv(os.path.join(output_path, "ensemble1_proba.csv"))
...
if __name__ == "__main__":
    ...
    brf = BalancedRandomForestClassifier(n_estimators=500, class_weight="balanced_subsample")
